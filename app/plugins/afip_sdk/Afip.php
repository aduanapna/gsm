 ...
 * @package Afip
 * @version 0.5.1
 * Update 30/10/2022 (Actualizado por iD) https://stackoverflow.com/questions/4318870/soapfault-exception-could-not-connect-to-host
 **/
...
class Afip
{
	...
	function __construct($options)
	{
		...
		if (!isset($options['res_folder'])) {
			$this->RES_FOLDER = __DIR__ . '/Afip_res/res_folder/';
		} else {
